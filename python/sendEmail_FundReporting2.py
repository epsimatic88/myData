...
#receiversOthers = ['lxo@hicloud-investment.com','lny@hicloud-investment.com','jy@hicloud-investment.com','lcy@hicloud-investment.com','wjh@hicloud-investment.com','fl@hicloud-investment.com']
## -----------------------------------------------------------------------------
...
## =============================================================================
xlsxpart = MIMEApplication(open('/home/fl/myData/data/Fund/nav_云扬1号.xlsx', 'rb').read())
xlsxpart.add_header('Content-Disposition', 'attachment', filename='nav_云扬1号.xlsx')
msg.attach(xlsxpart)
