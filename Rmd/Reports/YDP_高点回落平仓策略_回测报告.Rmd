...
setwd("2016-09-17")
file_name <- "YDP_all"
file_name <- paste0(file_name, "_dataset")
...
1 & 2006 & \cellcolor{redup!80} 44.64\% & 5.25\% & 8.51 \\ 
  2 & 2007 & \cellcolor{redup!100} 107.44\% & 10.95\% & 9.81 \\ 
  3 & 2008 & \cellcolor{greendown!75} -7.02\% & 24.18\% & -0.29 \\ 
  4 & 2009 & \cellcolor{redup!82} 45.83\% & 19.01\% & 2.41 \\ 
  5 & 2010 & \cellcolor{redup!52} 3.43\% & 7.35\% & 0.47 \\ 
  6 & 2011 & \cellcolor{redup!55} 6.33\% & 9.44\% & 0.67 \\ 
  7 & 2012 & \cellcolor{redup!75} 35.47\% & 7.38\% & 4.80 \\ 
  8 & 2013 & \cellcolor{redup!65} 10.90\% & 2.54\% & 4.29 \\ 
  9 & 2014 & \cellcolor{redup!64} 10.53\% & 5.28\% & 1.99 \\ 
  10 & 2015 & \cellcolor{redup!90} 60.81\% & 12.73\% & 4.78 \\ 
  11 & 2016 & \cellcolor{greendown!80} -9.16\% & 31.29\% & -0.29 \\  
...
\begin{center}
\begin{figure}
\includegraphics[width=14cm]{ydp_all.png}
\caption{YDP 基金产品组合}
\end{figure}
\end{center}
