...
## http://quotes.money.163.com/cjmx/2018/20180116/1002063.xls
...
DATA_PATH = '/data/ChinaStocks/TickData/From163/%s' % currTradingDay
...
def fetchTrade(code):
    ...
    if os.path.isfile(destFile) and os.stat(destFile).st_size > 10000:
