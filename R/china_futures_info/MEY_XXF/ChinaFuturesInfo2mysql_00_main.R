...
for(j in source_zgc){
  ...
  ## ---------------------------------------------------------------------------
  ## read data
  source('./R/china_futures_info/MEY_XXF/ChinaFuturesInfo2mysql_01_read_data.R')
  source('./R/china_futures_info/MEY_XXF/ChinaFuturesInfo2mysql_02_process_Instrument_info.R')
  ## ===========================================================================
  ...
  if(as.numeric(format(Sys.time(), "%H")) %between% c(6, 18)){
    ## ----- 日盘 ----- ##
    source('./R/china_futures_info/MEY_XXF/ChinaFuturesInfo2mysql_03_process_CommissionRate_info.R')
  }
  ## ===========================================================================
}
